...
int main()
{
    ...
    // load textures and generate textures
    ...
    unsigned char *data = stbi_load(ROOT_DIR"resources/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    data = stbi_load(ROOT_DIR"resources/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
